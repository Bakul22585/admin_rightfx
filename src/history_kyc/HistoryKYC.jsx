...
const HistoryKYC = () => {
          ...
          <div>
            ...
            <div className="view-image-section">
              ...
              <div className="element">
                <label>Pan Card Img :</label>
                <label
                  htmlFor="contained-button-file_pan"
                  className="fileuploadButton"
                >
                  <Input
                    accept="image/*"
                    id="contained-button-file_pan"
                    type="file"
                    onChange={(e) => onSelectFile(e, "pan_card")}
                  />
                  {selectedPanCardFile ? (
                    <img
                      src={previewPancard}
              ...
              <div className="element">
                <label>Passbook Img :</label>
                <label
                  htmlFor="contained-button-file_passbook"
                  className="fileuploadButton"
                >
                  <Input
                    accept="image/*"
                    id="contained-button-file_passbook"
                    type="file"
                    onChange={(e) => onSelectFile(e, "passbook")}
                  />
  ...
  const formSubmit = async () => {
    ...
    if (form.remark == "") {
      ...
      await axios
        .post(`${Url}admin/ajaxfiles/kyc_manage.php`, param)
        .then((res) => {
          if (res.data.message == "Session has been expired") {
            localStorage.setItem("login", true);
            navigate("/");
