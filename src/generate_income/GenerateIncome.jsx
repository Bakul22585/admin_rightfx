...
const GenerateIncome = () => {
        ...
        return <div>
            <div className='element'>
                <Box sx={{ display: 'flex', alignItems: 'flex-end',width: '100%' }}>
                    ...
                    <TextField type='password' label="Verify Current Password" variant="standard" sx={{ width: '100%' }} onChange={input} name='password'/>
                </Box>
            </div>
        </div>;
    }
    ...
    const manageDialogActionButton = () => {
        return <div className='dialogMultipleActionButton'>
            ...
            {(form.isLoader == true) ? <Button variant="contained" className='btn-gradient btn-success' disabled><i class="fa fa-refresh fa-spin fa-3x fa-fw"></i></Button> : <Button variant="contained" className='btn-gradient btn-success' onClick={formSubmit}>Submit</Button>}
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item sm={12} md={12} lg={12}>
                                                <div className='generate-group-btn'>
                                                    <Button variant="contained" className='partnership' onClick={(e) => handleClickOpen(e)}>Generate Partnership</Button>
                                                    <Button variant="contained" className='copy_trading' onClick={(e) => handleClickOpen(e)}>Generate Copy Trading</Button>
                                                </div>
                                            </Grid>
                                        </Grid>
                                    </CardContent>
