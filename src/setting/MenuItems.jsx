...
import { Button, Collapse, FormControl, Grid, InputLabel, Paper, Select, Switch, TextField, MenuItem, FormControlLabel, Checkbox } from "@mui/material";
...
const MenuItems = () => {
    ...
    const manageContent = () => {
        ...
        } else if (dialogTitle == "Edit Main Menu" || dialogTitle == "Edit Child Menu") {
            return (
                <div>
                    <div className="margeTwoField element">
                        {
                            (dialogTitle == "Edit Child Menu") ? <FormControlLabel sx={{ width: "100%" }}
                                label="Is Permission"
                                control={
                                    <Checkbox
                                        name="isPermission"
                    ...
                    <br />
                    {
                        (!form.isPermission) ? <><div className="margeTwoField element">
                            <TextField
                                type="text"
                                label="Icon"
                                variant="standard"
        ...
        if (dialogTitle == "Add Main Menu") {
            return (
                <div className="dialogMultipleActionButton">
                    ...
                    ) : (<Button variant="contained" className="btn-gradient btn-success" onClick={addMainMenu}>Add</Button>)}
                </div>
            );
            ...
            return (
                <div className="dialogMultipleActionButton">
                    ...
                    ) : (<Button variant="contained" className="btn-gradient btn-success" onClick={addMainMenu}>Update</Button>)}
                </div>
            );
        } else if (dialogTitle == "Add Child Menu") {
            return (
                <div className="dialogMultipleActionButton">
                    ...
                    ) : (<Button variant="contained" className="btn-gradient btn-success" onClick={addChildMenu}>Add</Button>)}
                </div>
            );
            ...
            return (
                <div className="dialogMultipleActionButton">
                    ...
                    ) : (<Button variant="contained" className="btn-gradient btn-success" onClick={addChildMenu}>Update</Button>)}
                </div>
            );
        } else if (dialogTitle == "Change Sub Menu Order") {
            return (
                <div className="dialogMultipleActionButton">
                    ...
                    ) : (<Button variant="contained" className="btn-gradient btn-success" onClick={saveSortdata}>Save</Button>)}
                </div>
            );
        }
    }
                                ...
                                >
                                    <div className="create-role-content-section">
                                        <div className="createMenuItemButtonEnd">
                                            <Button className="add-main-menu" variant="contained" onClick={handleClickOpen}>Add Main Menu</Button>
                                        </div>
                                        <ul className="role-management-section">
                                            {data.map((item, index) => {
                                                return (
                                                    <li className="main-menu-section">
                                                        <a className={`menu-${index} ${open[`menu-${index}`] ? "active" : ""}`} onClick={handleClick}>
                                                            <div>
                                                            ...
                                                            <div>
                                                                <Button className="edit-main-menu" title="Edit Main Menu" onClick={(e) => {
                                                                    handleClickOpen(e, item)
                                                                }}><i className={`material-icons edit-main-menu`}>edit_note</i></Button>
                                                                <Button className="add-child-menu" title="Add New Child Menu" onClick={(e) => {
                                                                    handleClickOpen(e, item)
