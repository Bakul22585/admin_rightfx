...
const Target = () => {
    ...
    const activityColumn = [
        ...
        },
        {
            name: 'USER NAME',
            selector: row => {
                return <span title={row.sales_porson_name}>{row.sales_porson_name}</span>
            },
            wrap: true,
            sortable: true,
            reorder: true,
        ...
        },
        {
            name: 'MANAGER',
            selector: row => {
                return <span title={row.sales_manager_master}>{row.sales_manager_master}</span>
            },
            wrap: true,
            sortable: true,
            reorder: true,
        ...
        },
        {
            name: 'STATUS',
            selector: row => {
                return <span title={(row.user_status == "0") ? "Pending" : (row.user_status == "1") ? "Approve" : "Rejected"} className={`text-color-${row.user_status == "1"
                    ? "green"
                    : row.user_status == "2"
                        ? "red"
                        : "yellow"
                    }`}>{(row.user_status == "0") ? "Pending" : (row.user_status == "1") ? "Approve" : "Rejected"}</span>
            },
            wrap: true,
            sortable: true,
            reorder: true,
        ...
        if (dialogTitle == 'Edit') {
            return <div>
                <div className='element'>
                    <TextField label="Account Target" variant="standard" sx={{ width: '100%' }} name='ac_target' onChange={input} value={form.ac_target} focused/>
                </div>
                <br/>
                <div className='element'>
                    <TextField label="Money In Target" variant="standard" sx={{ width: '100%' }} name='money_in_target' onChange={input} value={form.money_in_target} focused/>
                </div>
            </div>;
        }
    }
