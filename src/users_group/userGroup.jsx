...
const UsersGroups = () => {
    ...
    const deleteGroup = async (data) => {
        ...
        await axios.post(`${Url}/ajaxfiles/user_group_manage.php`, param).then((res) => {
            ...
            return (
                <div>
                    ...
                    <div className="margeField">
                        <FormControlLabel
                            control={
                                <Checkbox name="status" size="small" onChange={input} />
                            }
                            label="Status"
                        />
                    </div>
            ...
            return (
                <div>
                    ...
                    <div className="margeField">
                        <FormControlLabel
                            control={
                                <Checkbox name="status" checked={form.status} size="small" onChange={input} />
                            }
                            label="Status"
                        />
                    </div>
