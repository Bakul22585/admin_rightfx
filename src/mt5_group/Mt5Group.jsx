...
const Mt5Group = () => {
    ...
    const column = [
        ...
        {
            name: 'MT5 GROUP NAME',
            selector: row => { return <span title={row.mt5_group_name}>{row.mt5_group_name}</span> },
            sortable: true,
            reorder: true,
            wrap: true,
            grow: 0.5,
        ...
        if (dialogTitle == 'Add MT5 Groups') {
            return <div>
                <div className='margeField'>
                    <TextField label="Group Name" variant="standard" sx={{ width: '100%' }} name='group_name' onChange={input} />
                </div>
                <br />
                <div className='margeField'>
                    <TextField label="MT5 Group Name" variant="standard" sx={{ width: '100%' }} name='mt5_group_name' onChange={input} />
                </div>
                <br />
                <div className='margeField'>
                    <FormControlLabel
