import { Button, CardContent, Grid, Paper, Tab, Tabs, Typography, Box, TextField, FormControl, InputLabel, Select, MenuItem } from '@mui/material'
                                            ...
                                            <CardContent className="py-3">
                                                <Grid container spacing={2}>
                                                    <Grid item sm={12} md={12} lg={12}>
                                                        <CommonTable url={`${Url}/datatable/pamm/pamm_client_list.php`} column={column} sort='2' search={searchBy} searchWord={searchKeyword} param={param} refresh={refresh}/>
                                                    </Grid>
                                                </Grid>
                                            </CardContent>
                                        </Paper>
