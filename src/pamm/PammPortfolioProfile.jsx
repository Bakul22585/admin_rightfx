        ...
        axios
            ...
            .then((res) => {
                ...
                dailySalesOptions.series[0].data =
                    res.data.data.get_monthly_pnl_data.y;
                                        ...
                                        <div className="master__inner">
                                            <div className="money-manager-profile-view-section">
                                                <Grid container spacing={1}>
                                                    <Grid item md={6}><div className="master__section">
                                                                    ...
                                                                    <div className="portfolio-content-section">
                                                                        <div className="withdrawal-section">
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                style={{
                                                                                    color:
                                                                                        Number(info.return_percentage) >= 0
                                                                                            ? "green"
                                                                                            : "red",
                                                                                }}
                                                                            >
                                                                            ...
                                                                            <Grid item sm={6} md={3}>
                                                                                <FormControl fullWidth={true}>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        type="date"
                                                                                        onChange={(e) => {
                                                                                            tradeParam.end_date = e.target.value;
                                                                                            setTardeParam({ ...tradeParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        ...
                                                                                        onChange={(e) => {
                                                                                            investmentParam.start_date =
                                                                                                e.target.value;
                                                                                            setInvestmentParam({ ...investmentParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
                                                                            </Grid>
                                                                            <Grid item sm={6} md={3}>
                                                                                <FormControl fullWidth={true}>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        type="date"
                                                                                        onChange={(e) => {
                                                                                            investmentParam.end_date = e.target.value;
                                                                                            setInvestmentParam({ ...investmentParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        ...
                                                                                        onChange={(e) => {
                                                                                            withdrawParam.start_date =
                                                                                                e.target.value;
                                                                                            setWithdrawParam({ ...withdrawParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
                                                                            </Grid>
                                                                            <Grid item sm={6} md={3}>
                                                                                <FormControl fullWidth={true}>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        type="date"
                                                                                        onChange={(e) => {
                                                                                            withdrawParam.end_date = e.target.value;
                                                                                            setWithdrawParam({ ...withdrawParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        ...
                                                                                        onChange={(e) => {
                                                                                            commissionParam.start_date =
                                                                                                e.target.value;
                                                                                            setCommissionParam({ ...commissionParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
                                                                            </Grid>
                                                                            <Grid item sm={6} md={3}>
                                                                                <FormControl fullWidth={true}>
                                                                                    ...
                                                                                    <BootstrapInput
                                                                                        type="date"
                                                                                        onChange={(e) => {
                                                                                            commissionParam.end_date = e.target.value;
                                                                                            setCommissionParam({ ...commissionParam });
                                                                                        }}
                                                                                    ></BootstrapInput>
                                                                                </FormControl>
