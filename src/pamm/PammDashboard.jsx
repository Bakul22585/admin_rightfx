...
import { Button, ButtonGroup, CardContent, FormControl, Grid, MenuItem, Paper, Select } from "@mui/material";
import "./pamm.css";
    ...
    axios.post(Url + "/ajaxfiles/pamm/dashboard.php", param).then((res) => {
      ...
      if (res.data.status == "error") {
        ...
        dailySalesOptions.series[0].data =
          res.data.get_monthly_pnl_data.y;
        dailySalesOptions.xaxis.categories =
          res.data.get_monthly_pnl_data.x;
  ...
  const changeInvetsmentYear = (prop) => {
    ...
    axios.post(Url + "/ajaxfiles/pamm/dashboard.php", param).then((res) => {
      ...
      if (res.data.status == "error") {
        ...
        setResData({ ...res.data });
        investmentChart.series[0].data = res.data.yearly_pamm_investment_summary.y;
        investmentChart.xaxis.categories = res.data.yearly_pamm_investment_summary.x;
  ...
  const dashboardData = () => {
    ...
    axios.post(Url + "/ajaxfiles/pamm/dashboard.php", param).then((res) => {
      ...
      if (res.data.status == "error") {
        ...
        resData = res.data;
        setResData({ ...resData });
        chartvalue.options.series = [Number(res.data.total_investment), Number(res.data.total_pamm_withdrawal)];
                      ...
                      <CardContent className="py-3">
                        ...
                        >
                          ...
                          <div className="filter-with-group-button">
                            ...
                            <ButtonGroup variant="outlined">
                              <Button variant={`${invetsmentType == "yearly" ? 'contained' : 'outlined'}`} onClick={(e) => {
                                setInvestmentType('yearly');
                                investmentChart.series[0].data = resData.yearly_pamm_investment_summary.y;
                                investmentChart.xaxis.categories = resData.yearly_pamm_investment_summary.x;
                                setInvestmentChart({ ...investmentChart })
                                setInvetsmentLoader(true);
                                setTimeout(() => {
                                  setInvetsmentLoader(false);
                              ...
                              <Button variant={`${invetsmentType == "monthly" ? 'contained' : 'outlined'}`} onClick={(e) => {
                                setInvestmentType('monthly');
                                investmentChart.series[0].data = resData.monthly_pamm_investment.y;
                                investmentChart.xaxis.categories = resData.monthly_pamm_investment.x;
                                setInvestmentChart({ ...investmentChart })
                                setInvetsmentLoader(true);
                                setTimeout(() => {
                                  setInvetsmentLoader(false);
                              ...
                              <Button variant={`${invetsmentType == "weekly" ? 'contained' : 'outlined'}`} onClick={(e) => {
                                setInvestmentType('weekly');
                                investmentChart.series[0].data = resData.weekly_pamm_investment.y;
                                investmentChart.xaxis.categories = resData.weekly_pamm_investment.x;
                                setInvestmentChart({ ...investmentChart })
                                setInvetsmentLoader(true);
                                setTimeout(() => {
                                  setInvetsmentLoader(false);
                        ...
                        <Grid container spacing={2} sx={{ marginTop: "21px" }}  >
                          <Grid item md={12} lg={12} xl={12}>
                            <div className="remainderContentSection">
                              {(invetsmentLoader) ? (
                                <div className="loderforChart" style={{height: '300px'}}>
                                  <svg class="spinner" viewBox="0 0 50 50">
                                    <circle
                                      class="path"
                                      cx="25"
