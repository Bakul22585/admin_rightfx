                          ...
                          <div className="row">
                            <NavLink to="/pamm_user_management">
                              <div className="col s12 m12 text-align-center">
                                <h5 className="mb-0">{resData.total_pamm_user}</h5>
                      ...
                      <div className="row1 boxSection">
                        <div className="card padding-9 animate fadeLeft boxsize">
                          ...
                          <NavLink to="/pamm_mm_management">
                            <div className="col s12 m12 text-align-center">
                              <h5 className="mb-0">{(resData.total_pamm_manager == null) ? '0' : resData.total_pamm_manager}</h5>
                  ...
                  <Grid item sm={12} md={6} lg={6}>
                    <Paper elevation={2} style={{ borderRadius: "10px" }} className='paper-main-section'>
                      <div className="headerSection header-title">
                        ...
                        <span className='new-pamm-member-count'>{(resData.recent_pamm_users) ? resData.recent_pamm_users.length : "0"} New Member</span>
                      </div>
                      ...
                      {
                        (resData.recent_pamm_users) ? <div className='footer-section'>
                        <NavLink to='/pamm_user_management'>View All Users</NavLink>
                      </div> : "" 
                      }
